...
Los algoritmos de control de movimiento son los siguientes, el primero de solo movimiento del robot y el segundo soldadura de caja. 
2. En el archivo llamado CÓDIGO_MOVIMIENTO se puede ver el ejemplo de código usado para mover el robot en el laboratorio. 

3. En el archivo llamado Soldadura de caja.ls se puede encontrar el codigo desde el cual se hizo la simulación de la soldadura de caja a través del software de simulación SprutCAM. 

4. El video llamado VideoSoldaduraCaja encontrado en este repositorio es el video de muestra de la simulación de la soldadura de la caja.
